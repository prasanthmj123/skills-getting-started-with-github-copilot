...
activities = {
    ...
    "Basketball Club": {
        "description": "Train for basketball skills and play pickup games",
        "schedule": "Wednesdays and Fridays, 4:30 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["kevin@mergington.edu", "maria@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore painting, drawing, and mixed media art projects",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["lily@mergington.edu", "oliver@mergington.edu"]
    },
    "Drama Club": {
        "description": "Work on acting, script reading, and theater performances",
